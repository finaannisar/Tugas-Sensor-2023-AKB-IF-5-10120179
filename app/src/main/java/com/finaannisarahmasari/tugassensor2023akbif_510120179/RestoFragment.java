...
public class RestoFragment extends Fragment {
    ...
    public static RestoFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button cariResto = (Button) rootView.findViewById(R.id.cariResto);

        cariResto.setOnClickListener(new View.OnClickListener() {
            @Override
