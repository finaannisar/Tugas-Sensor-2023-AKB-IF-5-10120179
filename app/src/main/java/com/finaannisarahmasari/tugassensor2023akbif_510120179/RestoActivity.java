...
public class RestoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        supportMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.findResto);

        //Inisialisasi array
        String[] placeTypeList = {"atm","bank","hospital","movie_theater","restaurant"};
        //Inisialisasi array tempat
        String[] placeNameList = {"ATM","Bank","Hospital","Movie Theater","Restaurant"};

        //Set adapter di spinner
        spType.setAdapter(new ArrayAdapter<>(RestoActivity.this
        ...
        //Permission
        if (ActivityCompat.checkSelfPermission(RestoActivity.this
                , Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
            getCurentLocation();
        }else {
            ActivityCompat.requestPermissions(RestoActivity.this,
